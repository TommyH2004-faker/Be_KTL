        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Specialization = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentId = table.Column<Guid>(type: "uuid", nullable: false),
                    CourseId = table.Column<Guid>(type: "uuid", nullable: false),
                    CertificateCode = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true),
                    StreamKey = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: false),
                    PlaybackUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
                    RecordedVideoUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    Status = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Livestreams_Instructors_InstructorId",
                        column: x => x.InstructorId,
                        principalTable: "Instructors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WatchedPercentage = table.Column<decimal>(type: "numeric", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HlsUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseObjectives_IsDeleted",
                table: "CourseObjectives",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_CourseObjectives_OrderIndex",
                table: "CourseObjectives",
                column: "OrderIndex");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CourseRequirements_OrderIndex",
                table: "CourseRequirements",
                column: "OrderIndex");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonProgresses_IsDeleted",
                table: "LessonProgresses",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LessonResources_IsDeleted",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Livestreams_InstructorId",
                table: "Livestreams",
                column: "InstructorId");

            migrationBuilder.CreateIndex(
                name: "IX_Livestreams_IsDeleted",
                table: "Livestreams",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Livestreams_StartTime",
                table: "Livestreams",
                column: "StartTime");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSessions_ExpiredAt",
                table: "UserSessions",
                column: "ExpiredAt");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_StudentId_CourseId",
                table: "Wishlists",
                columns: new[] { "StudentId", "CourseId" },
                unique: true);
        }
